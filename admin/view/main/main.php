...
if((!isset($_SESSION['page']))&&(isset($_SESSION['username']))){
  ...
  include '/projetPHP/admin/view/header.php';
...
<?php include '/projetPHP/admin/view/navbar.php';?>
    <!-- partial -->
    <div class="container-fluid page-body-wrapper">
      <!-- partial:partials/_sidebar.html -->
<?php include '/projetPHP/admin/view/sidenav.php';?>
      <!-- partial -->
<?php include '/projetPHP/admin/view/'.$_SESSION['page'].'.php'?>
      <!-- main-panel ends -->
    </div>
